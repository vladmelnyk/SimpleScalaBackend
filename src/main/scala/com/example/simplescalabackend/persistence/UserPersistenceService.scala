package com.example.simplescalabackend.persistence

import scala.concurrent.ExecutionContext
import cats.effect.Blocker
import com.example.simplescalabackend.configuration.{DbConfig, dbConfig}
import com.example.simplescalabackend.{User, UserNotFound}
