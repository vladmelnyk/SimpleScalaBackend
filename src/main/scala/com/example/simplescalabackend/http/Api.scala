package com.example.simplescalabackend.http

import com.example.simplescalabackend.User
import com.example.simplescalabackend.persistence.{UserPersistence, createUser, deleteUser, getUser}
